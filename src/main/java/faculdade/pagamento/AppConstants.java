...
public class AppConstants {
    ...
    public static final String NOTIFICATION_URL = "http://localhost:8080/api/payments/";
    public static final String BASEURL_MERCADOPAGO = "https://api.mercadopago.com";
    public static final String GENERATEQRCODEURL_MERCADOPAGO = "/instore/orders/qr/seller/collectors/{user_id}/pos/{external_id}/qrs";
